...
@Component({
  selector: 'app-add-tne',
  templateUrl: './add-tne.component.html',
  styleUrls: ['./add-tne.component.scss']
})
export class AddTneComponent implements OnInit {
  ...
  getDataById(){
    ...
    this.service.tNEById(formData).subscribe((res: any) => {
...
this.router.navigate(['/providers'])
  ...
  onSubmit() {
    ...
    this.service.addTNE(formData).subscribe((data: any) => {
       this.uService.isLoading = false;

      if (data.status) {
        this.toaster.success(data.message)
        this.router.navigate(['/tne']);
      } else {
  ...
  onUpdate() {
    ...
    console.log(formData, 'formdata');
    this.service
      .updateTNEById(formData, this.tneId)
      .subscribe((data: any) => {
         this.uService.isLoading = false;
