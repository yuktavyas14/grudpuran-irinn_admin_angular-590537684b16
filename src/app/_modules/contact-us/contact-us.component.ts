...
export class ContactUsComponent implements OnInit {
  ...
  constructor(private service:ContactUsService, private router:Router,
     private langService: LanguageService,private uService:UtilitydesignService) {
    this.getPageList();
   }
  ngOnInit(): void {
  ...
  getPageList(){
    ...
    this.service.contactUsList(formData).subscribe((res:any)=>{
  ...
  onView(page:any){
    console.log(page)
    this.router.navigate(['/contact-us/edit',page.id,page.languageId])
  }
  onUpdateStatus(item:any){
    ...
    this.service.updateContactUsStatusById(formData).subscribe((data: any) => {
      this.uService.isLoading= false;
  ...
  onDelete(id:any){
    this.uService.isLoading= true;
    this.service.deleteContactUsById(id).subscribe((data: any) => {
      this.uService.isLoading= false;
