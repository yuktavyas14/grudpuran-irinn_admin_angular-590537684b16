...
export class LinksComponent implements OnInit {
  ...
  displayedColumns: string[] = ['SNo','linkTitle', 'linkUrl', 'linkMessage',
  'status','Action'];
...
constructor(private service:LinksService, private router:Router,private uService: UtilitydesignService) 
{
  this.getAllLinkData();
 }
ngOnInit(): void {
...
//   }
 ...
 getAllLinkData(){
  ...
  this.service.getAllImportantLinks().subscribe((res:any)=>{
...
onUpdateStatus(item:any){
  ...
  this.service.updateImpLinkByStatus(formData, item.linkId).subscribe((data: any) => {
   this.uService.isLoading= false;
