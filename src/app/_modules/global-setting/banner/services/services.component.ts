...
export class ServicesComponent implements OnInit {
  ...
  limit = '10';
  offset = 0;
  constructor(private service:GlobalSettingService, private router:Router,private uService: UtilitydesignService,
  ...
  onView(id:any){
    this.router.navigate(['/global-setting/banner/edit',id])
  }
  onUpdateStatus(item:any){
    ...
    this.service.updateBannerServiceByStatus(formData).subscribe((data: any) => {
     this.uService.isLoading= false;
